...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
// create-magic-component is installed globally on people's computers. This means
// that it is extremely difficult to have them upgrade the version and
// because there's only one global version installed, it is very prone to
// breaking changes.
//
// The only job of create-magic-component is to init the repository and then
// forward all the commands to the local version of create-magic-component.
//
// If you need to add a new command, please add it to the scripts/ folder.
//
// The only reason to modify this file is to add more warnings and
// troubleshooting information for the `create-magic-component` command.
//
// Do not make breaking changes! We absolutely don't want to have to
// tell people to update their global version of create-magic-component.
//
...
if (commands.length === 0) {
  if (argv.version) {
    console.log('create-magic-component version: ' + require('./package.json').version);
    process.exit();
  }
  console.error(
    'Usage: create-magic-component <project-directory> [--verbose]'
  );
  process.exit(1);
}
...
function checkNodeVersion(packageName) {
  ...
  if (!semver.satisfies(process.version, packageJson.engines.node)) {
    console.error(
      chalk.red(
        'You are currently running Node %s but create-magic-component requires %s.' +
...
// https://github.com/magic-FE/create-magic-component/pull/368#issuecomment-243446094
